                        ...
                        <div className="space-y-2">
                          {selectedGroup.members
                            .filter((member) => {
                              ...
                              if (dojFromDate) {
                                if (!member.user.dateOfJoining) return false;
                                const memberDoj = new Date(
                                  member.user.dateOfJoining
                                );
                              ...
                              return (
                                ...
                                >
                                  <Checkbox
                                    ...
                                    data-testid={`checkbox-exclude-${member.userId}`}
                                  />
                                  <Label
                                    htmlFor={`exclude-${member.userId}`}
